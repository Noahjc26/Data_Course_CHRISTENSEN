...
To start, I thought this would be easier if it was a dataframe so I turned it into a dataframe.
...
I think this solution is efficient and correct if you are looking for those six classifications, it first splits into the three *if statements* for Q values and then proceeds to deal with the A and P values
...
Let's look at the standard deviation based on the month for these 5 years:
...
September has the highest standard deviation and may has the lowest

Now let's look at the average over the 5 years compared to the average over the 30 years:
...
output <- c((paste0("nitrate was above standard for ",nrow(nitrate_site_1)," week(s) at site 1")),
(paste0("nitrate was above standard for ",nrow(nitrate_site_2)," week(s) at site 2")),
(paste0("nitrate was above standard for ",nrow(nitrate_site_3)," week(s) at site 3")),
(paste0("nitrate was above standard for ",nrow(nitrate_site_4)," week(s) at site 4")))
...
output <- c(
  paste0("phosphate was above standard for ", nrow(phosphate_site_1), " week(s) at site 1"),
  paste0("phosphate was above standard for ", nrow(phosphate_site_2), " week(s) at site 2"),
  paste0("phosphate was above standard for ", nrow(phosphate_site_3), " week(s) at site 3"),
  paste0("phosphate was above standard for ", nrow(phosphate_site_4), " week(s) at site 4")
)
...
output <- c(
  paste0("nitrate AND phosphate were above standard for ", nrow(both_site_1), " week(s) at site 1"),
  paste0("nitrate AND phosphate were above standard for ", nrow(both_site_2), " week(s) at site 2"),
  paste0("nitrate AND phosphate were above standard for ", nrow(both_site_3), " week(s) at site 3"),
  paste0("nitrate AND phosphate were above standard for ", nrow(both_site_4), " week(s) at site 4")
)
...
Site 4 seems to be of greatest concern, it has the most days over standard in phosphate and nitrate.


## #7

Let's look when nitrate was above standard for 3 consecutive weeks at site 1:
...
for (i in 1:(nrow(nitrate_site_1) - 2)) {
  ...
  if (end_date - start_date == 14) {
    cat(paste0("Three consecutive weeks of nitrate above standard found at site1:\n"))
...
Let's look when nitrate was above standard for 3 consecutive weeks at site 3:
...
for (i in 1:(nrow(nitrate_site_3) - 2)) {
  ...
  if (end_date - start_date == 14) {
    cat(paste0("Three consecutive weeks of nitrate above standard found at site3:\n"))
    cat(paste("Start Date:", start_date, "\n"))
    cat(paste("End Date:", end_date, "\n"))
    cat("\n")
  }
...
Let's look when nitrate was above standard for 3 consecutive weeks at site 4:
...
for (i in 1:(nrow(nitrate_site_4) - 2)) {
  ...
  if (end_date - start_date == 14) {
    cat(paste0("Three consecutive weeks of nitrate above standard found at site 4:\n"))
    cat(paste("Start Date:", start_date, "\n"))
    cat(paste("End Date:", end_date, "\n"))
    cat("\n")
  }
...
Let's look when phosphate was above standard for 3 consecutive weeks at site 1:
...
for (i in 1:(nrow(phosphate_site_1) - 2)) {
  ...
  if (end_date - start_date == 14) {
    cat(paste0("Three consecutive weeks of phosphate above standard found at site 1:\n"))
    cat(paste("Start Date:", start_date, "\n"))
    cat(paste("End Date:", end_date, "\n"))
    cat("\n")
  }
...
Let's look when phosphate was above standard for 3 consecutive weeks at site 3:
...
for (i in 1:(nrow(phosphate_site_3) - 2)) {
  ...
  if (end_date - start_date == 14) {
    cat(paste0("Three consecutive weeks of phosphate above standard found at site 3:\n"))
    cat(paste("Start Date:", start_date, "\n"))
    cat(paste("End Date:", end_date, "\n"))
    cat("\n")
  }
...
Let's look when phosphate was above standard for 3 consecutive weeks at site 4:
...
for (i in 1:(nrow(phosphate_site_4) - 2)) {
  ...
  if (end_date - start_date == 14) {
    cat(paste0("Three consecutive weeks of phosphate above standard found at site 4:\n"))
    cat(paste("Start Date:", start_date, "\n"))
    cat(paste("End Date:", end_date, "\n"))
    cat("\n")
  }
...
Let's look when phosphate AND nitrate were above standard for 3 consecutive weeks at site 1:
...
for (i in 1:(nrow(both_site_1) - 2)) {
  ...
  if (end_date - start_date == 14) {
    cat(paste0("Three consecutive weeks of phosphate and nitrate above standard found at site 1:\n"))
    cat(paste("Start Date:", start_date, "\n"))
    cat(paste("End Date:", end_date, "\n"))
    cat("\n")
  }
...
Let's look when phosphate AND nitrate were above standard for 3 consecutive weeks at site 3:
...
for (i in 1:(nrow(both_site_3) - 2)) {
  ...
  if (end_date - start_date == 14) {
    cat(paste0("Three consecutive weeks of phosphate and nitrate above standard found at site 3:\n"))
    cat(paste("Start Date:", start_date, "\n"))
    cat(paste("End Date:", end_date, "\n"))
    cat("\n")
  }
...
Let's look when phosphate AND nitrate were above standard for 3 consecutive weeks at site 4:
...
for (i in 1:(nrow(both_site_4) - 2)) {
  ...
  if (end_date - start_date == 14) {
    cat(paste0("Three consecutive weeks of phosphate and nitrate above standard found at site 4:\n"))
    cat(paste("Start Date:", start_date, "\n"))
    cat(paste("End Date:", end_date, "\n"))
    cat("\n")
  }
...
April seems to be the most common time for nitrate and phosphate to peak, specifically at site 1. 
...
Given the black line indicating the standard, site 2 is the only sight that does not need to take action for remediation efforts. Site 4 must look at their stream sources and fix the issue immediately, as this sight is above standard majority of the time for phosphate levels, and frequently above standard for nitrate levels.
...
This relationship does appear positively linear, albeit with a large SD
...
R^2 is 0.32 and p value is 0.005. These values are significant.

## #12
Given the model, and increase of 5 degrees would make the production go up by x*1.141: causing a 5.705 kWh increase in production.

## #13

Here is the summary of the model created only by the cumulative degradation:
...
solar_df %>% 
  ...
  geom_smooth() +
  theme_bw() +
  labs(x="Production (kWh)",
       y="Cumulative Degradation (%)")
```

This plot shows nearly 0 correlation.

```{r}

cat("Total degradation:", sum(solar_df$degrade_percent), "%")
```
...
cat("Total production:",sum(solar_df$production) * 0.0036,"GJ")
```

## #15
```{r}
kW <- solar_df$production / 12

total_kW <- sum(kW)

cat("Total kW generated:",total_kW)
```
